...
if (currentTheme) {
    ...
    darkButton.querySelector('svg').innerHTML = mode[currentTheme];
}
...
function darkSwitch() {
    if (localStorage.getItem('theme') === 'dark') {
        ...
        darkButton.querySelector('svg').innerHTML = mode.light
    } else {
        document.documentElement.setAttribute('data-theme', 'dark');
        localStorage.setItem('theme', 'dark');
        darkButton.querySelector('svg').innerHTML = mode.dark
    }
}
